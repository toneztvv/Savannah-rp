SAVANNAH RP WEBSITE — SERVER LAUNCH PACKAGE

This folder is the full static site for the Savannah RP FiveM server.
Open index.html locally, or upload the whole folder to your web host (see DEPLOY.md).
...
- Store buttons show STORE COMING SOON until your Tebex URL is ready
- Mobile navigation included
- hero-reference.png is the temporary hero background (replace with final art when ready)

Still needed from you before go-live:
- Discord invite URL
- FiveM public Cfx.re join code + direct-connect / server IP
- Support contact email
- Official Tebex store URL (optional until store launches)
- Final hero artwork / screenshots
